...
<div class="container">
	...
	<div class="row clearfix well">
		...
		<div class="col-md-6 column">
			...
			<form action="<c:url value='/usuario/atualizarSenha'/>" role="form" method="POST">
				...
				<div class="form-group">
					 ...
					 <div class="input-group">
					 	...
					 	<input class="form-control" id="inputSenhaNova" type="password" name="novaSenha" required="required">
					 </div>
				</div>
